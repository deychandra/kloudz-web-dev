...
import { FiGlobe, FiUsers, FiCode, FiHeart, FiAward, FiTrendingUp } from 'react-icons/fi';
...
const story = [
          {
                    year: '2015',
                    title: 'Founded',
                    description: 'Started with a small team of 5 passionate engineers in Bangalore.',
          },
          {
                    year: '2017',
          ...
          },
          {
                    ...
                    description: 'Shifted focus to enterprise-grade solutions and dedicated teams.',
          },
          {
                    year: '2021',
                    title: '100+ Engineers',
          ...
          },
          {
                    year: '2023',
                    title: 'AI & Automation',
                    description: 'Launched dedicated AI practice to help clients leverage generative AI.',
          },
          {
                    year: 'Today',
                    title: '200+ Professionals',
                    description: 'Serving 50+ clients across 15 countries with world-class engineering.',
          },
];
...
const values = [
          {
                    ...
                    description: 'We take pride in writing clean, maintainable code that scales.',
          },
          {
                    icon: FiUsers,
                    title: 'Client Partnership',
                    description: 'We treat every client project as if it were our own business.',
          },
          {
                    icon: FiHeart,
                    title: 'Developer Experience',
                    description: 'Happy developers build better products. We invest in our team.',
          },
          {
                    icon: FiTrendingUp,
                    title: 'Continuous Learning',
                    description: 'Technology evolves fast. We never stop learning and improving.',
          },
          {
                    icon: FiGlobe,
                    title: 'Global Mindset',
                    description: 'We work across timezones and cultures with empathy and respect.',
          },
          {
                    icon: FiAward,
                    title: 'Quality First',
...
const leadership = [
          { name: 'Rajesh Kumar', role: 'CEO & Founder', bio: '15+ years in enterprise software' },
          { name: 'Priya Sharma', role: 'CTO', bio: 'Ex-Google, distributed systems expert' },
          { name: 'Amit Patel', role: 'VP Engineering', bio: 'Built teams from 10 to 100+' },
          { name: 'Sarah Chen', role: 'VP Sales', bio: 'Enterprise sales leader, ex-Oracle' },
];

const offices = [
          { city: 'Bangalore, India', type: 'HQ & Engineering Center', size: '150+ engineers' },
          { city: 'Hyderabad, India', type: 'Development Center', size: '30+ engineers' },
          { city: 'San Francisco, USA', type: 'Sales & Client Success', size: 'Sales team' },
];
                              ...
                              <CinematicHero
                                        ...
                                        title={
                                                  <>
                                                            ...
                                                            <span className="word inline-block text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent-cyan to-accent-purple">Build</span>{' '}
                                                            <span className="word inline-block">Products</span>{' '}
                                                            <span className="word inline-block">&</span>{' '}
                                                            <span className="word inline-block text-transparent bg-clip-text bg-gradient-to-r from-accent-purple via-primary to-accent-cyan">Scale</span>{' '}
                                        ...
                                        subtitle={
                                                  <>
                                                            ...
                                                            <span className="text-accent-purple font-medium">enterprises</span> build world-class products and engineering teams.
                                                  </>
                                        }
                                        variant="purple"
                              />
