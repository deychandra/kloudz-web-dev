                              ...
                              <CinematicHero
                                        ...
                                        title={
                                                  <>
                                                            ...
                                                            <span className="word inline-block text-transparent bg-clip-text bg-gradient-to-r from-accent-purple to-primary">Great</span>
                                                  </>
                                        }
                                        subtitle={
                                                  <>
                                                            Have a project in mind or need to{' '}
                                                            <span className="text-primary font-medium">scale your team</span>? We'd love to hear from you.
                                                  </>
                                        }
                                        variant="cyan"
                                        minHeight="60vh"
